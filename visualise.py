...
# Convert P95 and P99 to easily visualisable numerical data
...
# Create multiple graphs for comparisons of various data points
...
latency_df['Models'] = latency_df['Model Name'].astype(str) + ' (' + latency_df['Test Difficulty'].astype(str) + ', runs=' + latency_df['Total Runs'].astype(int).astype(str) + ')'
...
p95_trace = go.Bar(x=latency_df['Models'], y=latency_df['P95 Latency'], name='P95')
p99_trace = go.Bar(x=latency_df['Models'], y=latency_df['P99 Latency'], name='P99')
